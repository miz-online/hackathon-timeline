...
const en: Dict = {
  ...
  "io.hint": "Full backup: settings, rooms, entries, color schemes, ads and logo as one JSON file.",
  "io.export": "Export configuration",
  "io.import": "Import configuration",
  "io.imported": "Configuration imported",
  "io.importConfirm": "Import replaces all entries, rooms, color schemes and ads. Continue?",
};
...
const de: Dict = {
  ...
  "io.title": "Import / Export",
  "io.hint": "Vollständige Sicherung: Einstellungen, Räume, Einträge, Farbschemata, Anzeigen und Logo als eine JSON-Datei.",
  "io.export": "Konfiguration exportieren",
  "io.import": "Konfiguration importieren",
  "io.imported": "Konfiguration importiert",
  "io.importConfirm": "Der Import ersetzt alle Einträge, Räume, Farbschemata und Anzeigen. Fortfahren?",
};
