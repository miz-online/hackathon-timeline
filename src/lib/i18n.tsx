...
const en: Dict = {
  ...
  "teams.edit": "Edit",
  "teams.delete": "Delete",
  "teams.hint": "Teams are used for practice-time entries. Order defines the practice slots.",
  ...
  "settings.practiceMinutes": "Practice time per team (minutes)",
  "settings.practiceScope": "Show practice entries",
...
const de: Dict = {
  ...
  "teams.hint": "Teams werden für Übungszeit-Einträge genutzt. Die Reihenfolge bestimmt die Slots.",
  ...
  "entries.newPractice": "Übungszeit",
  "entries.editPractice": "Übungszeit bearbeiten",
  "entries.form.practiceHint": "Übungseinträge werden in der Anzeige je Team in eine Zeile aufgeteilt.",
  "entries.form.practiceEndHint": "Endzeit = Start + {teams} Teams x {minutes} Min.",
  "settings.sec.teams": "Teams",
  "settings.practiceMinutes": "Übungszeit pro Team (Minuten)",
  "settings.practiceScope": "Übungseinträge anzeigen",
