...
const en: Dict = {
  ...
  "entries.mode.preview": "Preview",
  "entries.preview.noSet": "No slide set selected",
  "entries.preview.noPracticeTeams": "No teams registered",
  ...
  "settings.dangerHint":
    "Deletes this organization with all entries, rooms, colors, slides and the logo. This cannot be undone.",
  ...
  "settings.template.slides": "Slides",
  ...
  "slides.addTeams": "Add 16:9 team plan slide",
  "slides.kind.teams": "Team plan",
  "slides.uploaded": "Slides uploaded",
  "slides.empty": "No slides yet.",
  "slides.delete": "Delete",
  "slides.deleted": "Slide deleted",
  "slides.saved": "Slide saved",
  "slides.download": "Download",
  "slides.confirmDelete": "Delete this slide?",
  "slides.tooLarge": "Image is too large (max 10 MB)",
  "slides.displayEmpty": "No slides configured",
  "slides.duration": "Duration (seconds)",
  "slides.durationHint": "Empty uses the set duration.",
  "slides.edit": "Edit",
  "slides.editTitle": "Edit slide",
  "slides.filename": "File name",
  "slideSets.title": "Slide sets",
  "slideSets.new": "New set",
  "slideSets.newName": "Set",
  "slideSets.empty": "No slide sets yet. Create one to upload slides.",
  "slideSets.name": "Name",
  "slideSets.seconds": "Default duration (seconds)",
  "slideSets.save": "Save set",
  "slideSets.saved": "Slide set saved",
  "slideSets.delete": "Delete set",
  "slideSets.deleted": "Slide set deleted",
  "slideSets.confirmDelete": "Delete this set and all its slides?",
  "slideSets.showRoomName": "Room name",
  "slideSets.showClock": "Clock",
  ...
  "teams.print.tab": "Print view",
  "teams.print.title": "Team schedule",
  "teams.print.action": "Print",
  "teams.gridPrint.tab": "16:9 plan",
  "teams.gridPrint.title": "16:9 team schedule",
  ...
  "entries.newRegister": "New registration entry",
  "entries.kind.register": "Registration",
  ...
  "reg.formTitle": "Register your team",
  "reg.name": "Team name",
  "reg.members": "Members",
  "reg.membersPh": "Anna, Ben, Chris",
  "reg.membersHint": "Comma-separated names.",
  "reg.project": "Project description",
  "reg.room": "Room",
  "reg.roomHint": "Preselected from the display you scanned. The organizers can change it later.",
  "reg.noRoom": "No room yet",
  "reg.submit": "Register team",
  "reg.saving": "Saving...",
  "reg.save": "Save changes",
  "reg.saved": "Saved.",
  "reg.doneTitle": "Team registered",
  "reg.doneBody": "Bookmark this link — you can use it to update your team later.",
  "reg.editTitle": "Edit your team",
  "reg.lockedBody": "Team editing has been closed by the organizers.",
  "reg.copy": "Copy link",
  "reg.copied": "Link copied",
  "reg.welcomeTitle": "Team registered",
  "reg.welcomeBody": "Your team is saved. You can update it anytime on this page.",
  "reg.bookmarkHint": "Tip: bookmark this page now (Ctrl/Cmd + D) so you can find it again easily.",
  "reg.showShare": "Share link",
  "reg.hideShare": "Hide link",
  "teams.selfRegistered": "Self-registered",
  "teams.copyEditLink": "Copy edit link",
  "teams.lockEdit": "Lock team self-editing",
  "teams.lockEditHint": "When locked, self-registered teams can no longer change their entry.",

  "admin.tabs.files": "Files",
  "files.title": "Organization downloads",
  "files.hint": "These files are offered to every team as a download. Teams cannot change or delete them.",
  "files.teamTitle": "Files of {name}",
  "files.myTitle": "My files",
  "files.myHint": "Only your team and the organizers can see these files.",
  "files.sharedTitle": "Organization downloads",
  "files.sharedHint": "Provided by the organizers, read only.",
  "files.upload": "Upload",
  ...
  "files.renamed": "Name saved",
  "files.tooLarge": "The file is larger than {mb} MB.",
  "files.maxHint": "Maximum file size: {mb} MB.",
  "files.locked": "Uploading and deleting is currently disabled.",
  "settings.filesMode": "File management",
  "settings.filesMode.off": "Off",
  "settings.filesMode.download": "Organization downloads only",
  ...
  "settings.teamQuotaMb": "Storage limit per team (MB)",
  "settings.teamQuotaHint": "Total size of all files of a team. 0 = unlimited.",
...
const de: Dict = {
  ...
  "entries.preview.noPracticeTeams": "Keine Teams registriert",
  "entries.mode.json": "JSON",
  "entries.mode.preview": "Vorschau",
  "entries.preview.noSet": "Kein Folien-Set gewählt",
  ...
  "admin.tabs.slides": "Anzeigen",
  "settings.template.slides": "Folien",
  "settings.slideSeconds": "Anzeigedauer je Anzeige (Sekunden)",
  "settings.slideSecondsHint": "Gilt global für alle Anzeigen in allen Räumen.",
  ...
  "slides.upload": "Folien hochladen",
  "slides.addEntries": "Einträge-Folie hinzufügen",
  "slides.kind.entries": "Einträge",
  "slides.addTeams": "16:9-Teamplan-Folie hinzufügen",
  "slides.kind.teams": "Teamplan",
  "slides.uploaded": "Folien hochgeladen",
  "slides.empty": "Noch keine Folien.",
  "slides.delete": "Löschen",
  "slides.deleted": "Folie gelöscht",
  "slides.saved": "Folie gespeichert",
  "slides.download": "Herunterladen",
  "slides.confirmDelete": "Diese Folie löschen?",
  "slides.tooLarge": "Bild ist zu groß (max. 10 MB)",
  "slides.displayEmpty": "Keine Folien konfiguriert",
  "slides.duration": "Dauer (Sekunden)",
  "slides.durationHint": "Leer nutzt die Set-Dauer.",
  "slides.edit": "Bearbeiten",
  "slides.editTitle": "Folie bearbeiten",
  "slides.filename": "Dateiname",
  "slideSets.title": "Folien-Sets",
  "slideSets.new": "Neues Set",
  "slideSets.newName": "Set",
  "slideSets.empty": "Noch keine Folien-Sets. Erstelle eines, um Folien hochzuladen.",
  "slideSets.name": "Name",
  "slideSets.seconds": "Standarddauer (Sekunden)",
  "slideSets.save": "Set speichern",
  "slideSets.saved": "Folien-Set gespeichert",
  "slideSets.delete": "Set löschen",
  "slideSets.deleted": "Folien-Set gelöscht",
  "slideSets.confirmDelete": "Dieses Set und alle enthaltenen Folien löschen?",
  ...
  "teams.print.tab": "Druckansicht",
  "teams.print.title": "Teamplan",
  "teams.print.action": "Drucken",
  "teams.gridPrint.tab": "16:9-Plan",
  "teams.gridPrint.title": "16:9-Teamplan",
  ...
  "io.section.slide_sets": "Anzeigen-Sets",
  "io.section.slides": "Anzeigen",
  ...
  "entries.form.slidesHint":
    "Anzeigen im Modus „Automatisch\" spielen dieses Folien-Set zwischen Start- und Endzeit und wechseln danach zurück zum Zeitplan. Raum-Tags begrenzen es auf diese Räume.",
  ...
  "reg.formTitle": "Team registrieren",
  "reg.name": "Teamname",
  "reg.members": "Teilnehmer",
  "reg.membersPh": "Anna, Ben, Chris",
  ...
  "reg.copied": "Link kopiert",
  "reg.welcomeTitle": "Team registriert",
  "reg.welcomeBody": "Dein Team ist gespeichert. Du kannst es jederzeit auf dieser Seite aktualisieren.",
  "reg.bookmarkHint": "Tipp: Speichere diese Seite jetzt als Lesezeichen (Strg/Cmd + D), damit du sie leicht wiederfindest.",
  "reg.showShare": "Link teilen",
  "reg.hideShare": "Link ausblenden",
  "teams.selfRegistered": "Selbstregistriert",
  ...
  "admin.tabs.files": "Dateien",
  "files.title": "Downloads der Organisation",
  "files.hint":
    "Diese Dateien werden allen Teams zum Download angeboten. Teams können sie nicht ändern oder löschen.",
  "files.teamTitle": "Dateien von {name}",
  "files.myTitle": "Meine Dateien",
  "files.myHint": "Diese Dateien sehen nur dein Team und die Organisation.",
  "files.sharedTitle": "Downloads der Organisation",
  "files.sharedHint": "Von der Organisation bereitgestellt, nur zum Herunterladen.",
  ...
  "files.manage": "Dateien",
  "files.empty": "Noch keine Dateien.",
  "files.confirmDelete": "Diese Datei löschen?",
  "files.deleted": "Datei gelöscht",
  "files.uploaded": "Datei hochgeladen",
  "files.renamed": "Name gespeichert",
  "files.tooLarge": "Die Datei ist größer als {mb} MB.",
  "files.maxHint": "Maximale Dateigröße: {mb} MB.",
  "files.locked": "Hochladen und Löschen sind derzeit deaktiviert.",
  "settings.filesMode": "Dateiverwaltung",
  "settings.filesMode.off": "Aus",
  "settings.filesMode.download": "Nur Downloads der Organisation",
  ...
  "settings.teamQuotaMb": "Speicherlimit pro Team (MB)",
  "settings.teamQuotaHint": "Gesamtgröße aller Dateien eines Teams. 0 = unbegrenzt.",
