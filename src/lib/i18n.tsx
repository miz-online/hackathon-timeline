...
const de: Dict = {
  ...
  "entries.preview.noSet": "Kein Slide-Set gewählt",
  ...
  "slides.deleted": "Slide gelöscht",
  "slides.saved": "Slide gespeichert",
  "slides.download": "Herunterladen",
  "slides.confirmDelete": "Diesen Slide löschen?",
  "slides.tooLarge": "Bild ist zu groß (max. 10 MB)",
  "slides.displayEmpty": "Keine Slides konfiguriert",
  "slides.duration": "Dauer (Sekunden)",
  "slides.durationHint": "Leer nutzt die Set-Dauer.",
  "slides.edit": "Bearbeiten",
  "slides.editTitle": "Slide bearbeiten",
  "slides.filename": "Dateiname",
  "slideSets.title": "Slide-Sets",
  "slideSets.new": "Neues Set",
  "slideSets.newName": "Set",
  "slideSets.empty": "Noch keine Slide-Sets. Erstelle eines, um Slides hochzuladen.",
  "slideSets.name": "Name",
  "slideSets.seconds": "Standarddauer (Sekunden)",
  "slideSets.save": "Set speichern",
  "slideSets.saved": "Slide-Set gespeichert",
  ...
  "entries.newSlides": "Neuer Slides-Eintrag",
  "entries.kind.slides": "Slides",
  "entries.form.slideSet": "Slide-Set",
