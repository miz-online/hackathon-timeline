...
export const TABLES: TableMeta[] = [
  {
    ...
    columns: [
      ...
      { name: "slide_seconds", kind: "int", def: 10 },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "team_id", kind: "uuid", references: "teams.id" },
      { name: "ref_id", kind: "text", nullable: true },
      { name: "name", kind: "text" },
      { name: "storage_key", kind: "text" },
      { name: "content_type", kind: "text", def: "application/octet-stream" },
      { name: "size_bytes", kind: "int", def: 0 },
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "tenant_id", kind: "uuid", references: "tenants.id" },
      { name: "ref_id", kind: "text", nullable: true },
      { name: "name", kind: "text", def: "Slides" },
      { name: "slide_seconds", kind: "int", def: 10 },
      { name: "sort_order", kind: "int", def: 0 },
      { name: "show_room_name", kind: "bool", def: true },
      { name: "show_clock", kind: "bool", def: true },
      { name: "show_logo", kind: "bool", def: true },
      ts("created_at", "now"),
      ts("updated_at", "now"),
    ],
  },
  {
    ...
    columns: [
      ...
      { name: "sort_order", kind: "int", def: 0 },
      { name: "duration_seconds", kind: "int", nullable: true },
      ts("created_at", "now"),
      ts("updated_at", "now"),
