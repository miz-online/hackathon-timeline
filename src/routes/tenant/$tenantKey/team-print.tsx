...
import { TeamPrintSheet } from "@/components/admin/TeamPrintSheet";
import { Card } from "@/components/ui/card";
import { getTenant, listColorSchemes, listRooms, listTeams } from "@/lib/board.functions";
import { useI18n } from "@/lib/i18n";

export const Route = createFileRoute("/tenant/$tenantKey/team-print")({
  head: () => ({
    meta: [
      { title: "Team schedule print view — Room Board" },
      { name: "description", content: "A print-ready, chronologically ordered team schedule." },
      { property: "og:title", content: "Team schedule print view — Room Board" },
      { property: "og:description", content: "A print-ready, chronologically ordered team schedule." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
  }),
  component: TeamPrintPage,
});

function TeamPrintPage() {
